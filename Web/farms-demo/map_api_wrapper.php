...
function get_geocode($address){
    ...
    $url ="https://maps.googleapis.com/maps/api/geocode/json?address={$address}&key=AIzaSyAEkREi8hAMor_iGOm3LdUwPYh74mLjvdQ";
...
if (isset($_GET['city'])) $my_city=$_GET['city'];
echo json_encode(get_geocode($my_city));
?>